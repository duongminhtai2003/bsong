...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/templates/public/css/coin-slider.css" />
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/templates/admin/js/script.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/templates/admin/js/coin-slider.min.js"></script>
<style type="text/css">
	...
	<div id="wrapper">
		<nav class="navbar navbar-default navbar-cls-top " role="navigation"
			...
			<div
				...
				Xin chào, <b><%=userInfo.getFullname()%></b> &nbsp; <a
