...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li id="index"><a href="<%=request.getContextPath() %>/index"><span>Trang chủ</span></a>
          <li id="contact"><a href="<%=request.getContextPath() %>/contact"><span>Liên hệ</span></a></li>
          <li id="admin"><a href="<%=request.getContextPath() %>/auth/login"><span>Đăng nhập</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"><a href="<%=request.getContextPath() %>/index"><img src="<%=request.getContextPath() %>/templates/public/images/slide1.jpg" width="935" height="307" alt="" /></a> <a href="<%=request.getContextPath() %>/index"><img src="<%=request.getContextPath() %>/templates/public/images/slide2.jpg" width="935" height="307" alt="" /></a> <a href="<%=request.getContextPath() %>/index"><img src="<%=request.getContextPath() %>/templates/public/images/slide3.jpg" width="935" height="307" alt="" /></a></div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
