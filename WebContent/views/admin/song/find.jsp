					...
					<div class="panel-body">
						<div class="table-responsive">
							<div class="row" style="margin-bottom: 30px;">
								<div class="col-sm-8">
									<a
										href="<%=request.getContextPath()%>/admin/song/add"
										class="btn btn-success btn-md" id=""> <i
										class="fa fa-plus"></i>&nbsp;Thêm
									</a>
								</div>
								<div class="col-md-4">
									<form action="<%=request.getContextPath()%>/admin/song/search" method="post">
										<div class="input-group form">
											<input type="text" class="form-control"
												placeholder="Tên bài hát..." name="name"> <span
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>
									...
									<tr class="gradeX">
										<td><%=s.getId()%></td>
										<td><a
											href="http://bsong.vinaenter.edu.vn/admincp/bai-hat/editSong.php?sid=4"><%=s.getName()%></a></td>
										<td><%=s.getCategory().getName()%></td>
										<td class="center"><%=s.getCounter()%></td>
										<td class="center">
											<%
												if (s.getPicture().isEmpty()) {
											%>
									...
									<div class="dataTables_paginate paging_simple_numbers"
										...
										<ul class="pagination">
											...
											<li class="paginate_button previous disabled"
												...
												href="<%=request.getContextPath()%>/admin/song/search?pageid=<%=currentPage - 1%>">Trang
													trước</a></li>
											<%
												} else {
											%>
											...
											<li class="paginate_button <%=active%>"
												...
												href="<%=request.getContextPath()%>/admin/song/search?pageid=<%=i%>"><%=i%></a></li>
											<%
												}
											%>
											<%
