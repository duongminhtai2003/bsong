					...
					<div class="panel-body">
						<div class="table-responsive">
							<div class="row" style="margin-bottom: 30px;">
								...
								<div class="col-md-4">
								<form action="<%=request.getContextPath()%>/admin/user/find" method="post">
									<div class="input-group form">
										<input type="text" class="form-control"
											placeholder="Search..." name="fullname"> <span
							...
							<%
								if (request.getParameter("msg") != null) {
														...
														switch (code) {
														case 0:
															out.print(CodeMessageUtil.displayMessage(out, "Chỉ có admin mới xử lý được!!!"));
															break;
														case 1:
								...
								<tbody>
									...
									<tr class="gradeX">
										...
										<td class="text-center"><a href="<%=urlEdit%>" title=""
											...
											onclick="return confirm('Bạn có chắc chắn muốn xóa ?');" href="<%=urlDel%>" title=""
											class="btn btn-danger"><i class="fa fa-trash-o"></i> Xóa</a></td>
									</tr>
									<%
										}
											}
